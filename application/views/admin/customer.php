                        ...
                        <div class="body table-responsive">
                            ...
                            <?php foreach ($query as $customer): ?>
                                <tr>
                                    ...
                                    <td><?php echo $customer->instagram ?></td>
                                    <td><?php echo $customer->tanggal_lahir ?></td>
                                    <td><?php echo $customer->pekerjaan ?></td>
                                    <td><?php echo $customer->instansi ?></td>
                                    <td><a href="<?= base_url('customer/edit_data/' . $customer->id_customer) ?>" class="btn btn-info">Edit data</a></td>
                                    <td>
                                        <form action="<?php echo base_url('customer/hapus_data') ?>" method="post">
                                            <input type="hidden" name="nomor_induk" value="<?php echo $customer->id_customer ?>">
